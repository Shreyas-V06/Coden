...
async def createRoom(player1_id,player2_id):
    ...
    await addRoom(roomid=room_id, player1_id=player1_id, player2_id=player2_id, question_ids=question_ids)
    player1_token = generate_jwt_token(player_id=player1_id, room_id=room_id, player_no=1)
    player2_token = generate_jwt_token(player_id=player2_id, room_id=room_id, player_no=2)
